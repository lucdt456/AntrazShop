...
function loadData() {
    $.ajax({
        ...
        success: function (response) {
            ...
            loadNewProduct(response.products);
        },
    ...
    $.ajax({
        url: window.API_URL + `/Shop/TopRating`,
        type: 'Get',
        headers: {
            'Authorization': 'Bearer ' + token
        },
    ...
    $.ajax({
        url: window.API_URL + `/Shop/TopSaling`,
        type: 'Get',
        headers: {
            'Authorization': 'Bearer ' + token
        },
...
function loadNewProduct(ProductList) {
...
function loadTopSaleProduct(ProductList) {
    $("#top-product-sale").empty();
...
function loadTopSoldProduct(ProductList) {
    $("#top-product-sold").empty();
...
function loadTopRatingProduct(ProductList) {
    $("#top-product-rating").empty();
